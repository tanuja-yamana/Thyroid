...
def main():
    ...
    # Sidebar
    st.sidebar.write("<h1 style='color: #F63366; font-size: 36px;'>Tanuja Yamana</h1>", unsafe_allow_html=True)

    st.sidebar.write("GitHub profile : (https://github.com/tanuja-yamana)")
    st.sidebar.write("LinkedIn profile : (https://www.linkedin.com/in/tanuja-yamana-09039922b)")
